...
public class DLListTest extends TestCase {
    /**
     * DLList cannot be independently created in order to finish some job
     * its functions are purely used to serve memory pool
     * 
     * the MemoryManager we will use
     */
    ...
    @Override
    public void setUp() {
        BufferPool buf = new BufferPool("output.txt", 5, 32);
        manager = new MemoryManager(20, buf);
    }
